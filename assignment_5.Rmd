...
1.
Results E the First part: instructions say "indicate values for the mean, and standard deviation, standard error *or* a 95% confidence interval". 
...
2. 
For Third part of Results E. 
- Maybe has to do with the fact that the histogram and qq plot do *not* really look normal?

3.
- For the beeswarm plot: there are a couple outliers for pool side channel that have a weight value of  like 85 and 88 so I made the y-scale to 100...
