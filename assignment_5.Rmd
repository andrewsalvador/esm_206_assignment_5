...
# Check the variance (who knows why)
leveneTest(weight ~ unittype, data = pgs_2017_graph)
...
```
One-way ANOVA with post-hoc Tukey's HSD shows a significant difference in mean weight between side-channel and pool salamanders (p < 0.05). Pool and cascade salamanders, and side-channel and cascade salamanders were not significantly different (p > 0.05)
...
- Maybe has to do with the fact that the histogram and qq plot do *not* really look super normal?
