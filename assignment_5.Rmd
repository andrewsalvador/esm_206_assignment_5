...
ggplot() +
  geom_jitter(data = pgs_2017_graph, 
                ...
                pch = 1,
                color = "gray50") +
  scale_x_discrete(labels = c( "Cascade", "Side-Channel", "Pool")) +
...
```
One-way ANOVA with post-hoc Tukey's HSD shows a significant difference in mean weight between side-channel and pool salamanders (p < 0.05). 
